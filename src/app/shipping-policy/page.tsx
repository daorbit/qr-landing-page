        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6">
          <section>
            ...
            <p className="text-muted-foreground">
              QR Studio is a digital service platform. All our products and services are delivered electronically. 
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              ...
              WEBP, and JPG. Downloads are available immediately after QR code generation.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              ...
              please contact our support team through the <Link href="/contact" className="text-primary hover:underline">Contact page</Link>.
            </p>
          </section>
        </div>
      </div>
