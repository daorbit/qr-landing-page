        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6">
          <section>
            ...
            <p className="text-muted-foreground">
              By accessing and using QR Studio, you accept and agree to be bound by the terms and provisions 
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              All content, features, and functionality of our service are owned by QR Studio and are protected 
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              QR Studio shall not be liable for any indirect, incidental, special, consequential, or punitive 
