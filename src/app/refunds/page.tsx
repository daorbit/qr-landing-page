      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6">
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              To request a refund, please contact our support team through the <Link href="/contact" className="text-primary hover:underline">Contact page</Link> with 
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              If you have any questions about our cancellation or refund policies, please reach out through our <Link href="/contact" className="text-primary hover:underline">Contact page</Link>.
            </p>
          </section>
        </div>
      </div>
